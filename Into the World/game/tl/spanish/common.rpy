...
translate spanish strings:
    ...
    new "La carga perderá el progreso no guardado. ¿Seguro que quieres hacer esto?"
    ...
    new "¿Estás seguro de que quieres volver al menú principal? Esto perderá el progreso no guardado."
    ...
    new "El archivo {a=edit:1:log.txt}log.txt{/a} puede contener información que le ayude a determinar el problema de su equipo."
...
translate spanish strings:
    ...
    new "Haga clic derecho o escape para salir."
    ...
    new "\n{color=#cfc}✔ imagen prevista (buena){/color} {color=#fcc}✘ imagen imprevista (mala){/color} {color=#fff}Arrastra para mover.{/color}"
