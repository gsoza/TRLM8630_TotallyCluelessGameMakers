...
translate chinese strings:
    ...
    new "\n{color=#cfc}✔ 预测图像（好）{/color} {color=#fcc}✘ 未预测图像（坏）{/color} {color=#fff}拖动移动。{/color}"
    ...
    new "有关如何解决此问题的更多详细信息，请参阅{a=[url]}documentation{/a}。"
